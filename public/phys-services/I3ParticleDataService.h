 ...
 * $Id: I3ParticleDataService.h,v 1.10 2005/04/04 18:40:40 pretz Exp $
 *
...
class I3ParticleDataService {
 public:
   ...
   */
  virtual I3Particle::ParticleType TranslateFromF2k(int f2k_id);

  /**
   * translates a particle from a character string.
   * @todo Is this needed?  I don't think so.  Remove this
   */
  virtual I3Particle::ParticleType TranslateFromString(const char* name);
   ...
   */
  virtual I3Particle::ParticleType TranslateFromPDG(int pdg_id);
   ...
   */
  virtual I3Particle::ParticleType TranslateFromCorsika(int corsika_id);
   ...
   */
  virtual double Mass(I3Particle::ParticleType particle);
   ...
   */
  virtual double LifeTime(I3Particle::ParticleType particle);
   ...
   */
  virtual bool Stable(I3Particle::ParticleType particle);
   ...
   */
  virtual double Charge(I3Particle::ParticleType particle);
   ...
   * '-1' if its unknown
   */
  int LightType(I3Particle::ParticleType particle);
...
typedef PtrPolicy<I3ParticleDataService>::ThePolicy I3ParticleDataServicePtr;
