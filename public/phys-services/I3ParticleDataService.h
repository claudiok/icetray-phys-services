 ...
 * $Id: I3ParticleDataService.h,v 1.4.2.1 2004/04/10 17:10:40 troy Exp $
 *
...
class I3ParticleDataService {
 public:
   ...
   */
  virtual I3Track::TrackType TranslateFromF2k(Int_t f2k_id);

  /**
   * translates a particle from a character string.
   * @todo Is this needed?  I don't think so.  Remove this
   */
  virtual I3Track::TrackType TranslateFromString(const Char_t* name);
   ...
   */
  virtual I3Track::TrackType TranslateFromPDG(Int_t pdg_id);

  /**
   * Translates a particle type from the Corsika convention
   * @param pdg_id the particle type in the Corsika convention
   * @return the corresponding I3Track::TrackType in the datacalsses convention
   * @todo implement this message.
   */
  virtual I3Track::TrackType TranslateFromCorsika(Int_t corsika_id);
   ...
   */
  virtual Double_t Mass(I3Track::TrackType particle);
   ...
   */
  virtual Double_t LifeTime(I3Track::TrackType particle);
   ...
   */
  virtual Bool_t Stable(I3Track::TrackType particle);
   ...
   */
  virtual Double_t Charge(I3Track::TrackType particle);
   ...
   */
  std::string ToString(I3Track::TrackType particle);
   ...
   * '-1' if its unknown
   */
  Int_t LightType(I3Track::TrackType particle);
