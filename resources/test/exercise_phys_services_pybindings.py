...
print "Working out I3XMLOMKey2MBID serivce"
...
print "Particle 1: ", part1.dir
print "Particle 2: ", part2.dir
print "Angle diff: ", anglediff/icetray.I3Units.deg
...
print "your I3CutValues: ", cv.cog, cv.ldir, cv.ndir, cv.nchan

print "Working out GCDFileService"

mytime = dataclasses.I3Time(2010, 158082172000000000)

infile = os.path.expandvars("$I3_PORTS/test-data/sim/GeoCalibDetectorStatus_IC86.55380_corrected.i3.gz")

my_fs = phys_services.I3GCDFileCalibrationService(infile)

my_cal = my_fs.get_calibration(mytime)
print "I found calibrations for ",len(my_cal.dom_cal), " DOMs"
