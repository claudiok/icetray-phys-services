...
channel_id_file = expandvars('$I3_WORK/amanda-core/resources/default_geometry.f2k');

tray.AddService('I3F2kFileFactory', 'f2k')
tray.SetParameter('f2k', 'Infile', F2kCascadeFile)
tray.SetParameter('f2k', 'ChannelID_file', channel_id_file);
...
tray.ConnectBoxes('calibratestatus', 'OutBox', 'hits')
